...
Link to another page in the Notion blog (@-style link): [Blogs using Notoma](https://nategadzi.github.io/notoma/blogs-using-notoma)
_For these links to work, you need to specify the permalink pattern for your blog in the_ [Configuration](https://nategadzi.github.io/notoma/configuration).
